...
```{r}
set.seed(1)
boost.red=gbm(quality~.,data=red[train,],distribution="gaussian",n.trees=5000, interaction.depth=4)
boost.pred=predict(boost.red,newdata=red.test, n.trees=5000)
...
The correct prediction is 0.765

```{r}
library(gbm)
set.seed(3)
boost.class.red=gbm(Highquality~.-quality,data=newred[train,],distribution="bernoulli",n.trees=5000, interaction.depth=4)
